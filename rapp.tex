...
Denna lab är utformad för att ge en större förståelse för halvledarkomponenter och dess samverkan med ljus, både emission (ljusluminicens) samt absorption kommer undersökas. Detta har ett extremt stort användningsområde tillexempel i kameror, där ljus ska översättas till digital data. Under labben kommer det kontrolleras om det stämmer att den våglängd med en energi lika med bandgapsenergin kommer att lysa med störst intensitet. Vidare kommer också absorptionskurvan att studeras. Teorin säger att fotodioden kommer börja absorbera fotoner i rymdladdningsområdet först då fotonerna har en våglängd som ger en energi som är lika med eller större än bandgapsenergin enligt $\lambda = hc/E_{fot}$, men då rymdladdningsområdet ligger en bit under ytan kommer absorptionskonstanten att öka i takt med fotonenergin och detta leder till att absorptionen kommer minska enligt följande formel.

\begin{equation}
  \Phi(x) =\Phi_0e^{-\alpha x}
\end{equation}

Diodens uppbyggnad kommer även att studeras då en egen diod kommer tillverkas och analyseras. Denna kommer konstrueras med hjälp av en platta av Galliumfosfid som kommer legeras med dels tenn dels zinklegerat guld. Detta kommer att n-,p-dopa GaP-biten tillräckligt för att den ska få en diods egenskaper. 

Vidare kommer en analys göras på en solcell för att undersöka vid vilken belastningsresistans denna uppnår sin maximala effekt. Belysning av en diod kommer att leda till uppkomsten av en ström genom dioden. Men om ingen belastningsresistans finns kommer det inte ligga någon spänning över dioden alltså ingen effekt. Om det istället ligger oändligt mycet belastning över dioden kommer det inte att gå någon ström, alltså ingen effekt. Det som måste göras är att hitta den punkt i ström/spänningkurvan som ger den största arean ($U*I=effekten$).
\section{Utförande}
...
\begin{figure}[H]
        ...
        \caption{Den röda grafen visar emissionen och den gröna visar absorptionen för dioden som en funktion av våglängden}
        \label{emabs}
\end{figure}
...
Vid analysering av den egentillverkade GaP-dioden syns tydligt diodens egenskaper (Figur \ref{diodiv}). Vid belysning reagerar dioden som förväntat då man kan se att en ström uppstår. Dioden gav tillockmed av sig ett svagt sken då strömmen genom denna ökades. Detta är ett kritiskt moment av labben då det finns en relativt stor risk att något blir fel. Vid konstruktionen krävs stor precition och det finns en stor risk att legeringen inte fungerar efter man har smält tennet och guldet. Sedan så måste ledarna fästas i dioden mycket noggrant för att kretsen ska fungera. Men efter några justeringar uppnåddes ett fint resultat. 

Studien av solcellen gav två mycket fina kurvor som utan tvekan kan knytas an till teorin. I figur \ref{solcelliv} ser man ett tydligt effektmaximum då lasten ligger på cirka 2$\Omega$. Mätvärdena som togs fram var dock aningen ostabila, de varierade relativt mycket med tiden. Mätvärdena kan alltså vara skyldiga till viss felmarginal och grafens något ryckiga utseende, men överlag är det ett mycket fint resultat.
